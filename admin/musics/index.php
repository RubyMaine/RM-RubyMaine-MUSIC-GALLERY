...
<div class="card card-outline rounded-0 card-purple">
	<div class="card-header">
		<h3 class="card-title"> Список музыки </h3>
		<div class="card-tools">
			<a href="./?page=musics/manage_music" class="btn btn-flat btn-primary" style="border-radius: 5px;"><span class="fas fa-plus-square"></span> Добавить новую музыку </a>
		</div>
	</div>
	<div class="card-body">
							...
							<tr>
								...
								<td align="center">
									...
									<div class="dropdown-menu" role="menu">
										<a class="dropdown-item view-data" href="<?= base_url."admin/?page=musics/view_music&id={$row['id']}" ?>"><span class="fa fa-eye text-light"></span> Посмотреть </a>
										<div class="dropdown-divider"></div>
										<a class="dropdown-item edit-data" href="<?= base_url."admin/?page=musics/manage_music&id={$row['id']}" ?>"><span class="fa fa-edit text-primary"></span> Редактировать </a>
										<div class="dropdown-divider"></div>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Вы уверены, что хотите удалить эту музыку навсегда?","delete_music",[$(this).attr('data-id')])
		})
		$('#create_new').click(function(){
			uni_modal("<i class='far fa-plus-square'></i> Добавить новую музыку ","musics/manage_music.php")
		})
		$('.edit-data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Добавить новую музыку ","musics/manage_music.php?id="+$(this).attr('data-id'))
		})
		$('.view-data').click(function(){
			uni_modal("<i class='fa fa-th-list'></i> Музыкальные подробности ","musics/view_music.php?id="+$(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [
