...
<div class="card card-outline rounded-0 card-purple">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="./?page=user/manage_user" id="create_new" class="btn btn-flat btn-primary" style="border-radius: 5px;"><span class="fas fa-plus"></span> Создать новый пользователей </a>
		</div>
	</div>
	<div class="card-body">
