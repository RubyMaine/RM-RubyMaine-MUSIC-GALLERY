...
<div class="card card-outline rounded-0 card-purple">
	...
	<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary rounded-2 mr-3" form="manage-user"> Сохранить данные пользователя </button>
					<a href="./?page=user/list" class="btn btn-sm btn-default border rounded-2" form="manage-user"><i class="fa fa-angle-left"></i> Отменить </a>
				</div>
			</div>
		</div>
</div>
