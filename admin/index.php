...
<?php require_once('inc/header.php') ?>
  ...
  <div class="modal fade" id="uni_modal" role='dialog'>
    <div class="modal-dialog modal-md modal-dialog-centered modal-dialog-scrollable rounded-0" role="document">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary rounded-2" id='submit' onclick="$('#uni_modal form').submit()"> Сохранить </button>
        <button type="button" class="btn btn-secondary rounded-2" data-dismiss="modal"> Отменить </button>
      </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="confirm_modal" role='dialog'>
    <div class="modal-dialog modal-md modal-dialog-centered rounded-0" role="document">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary rounded-2" id='confirm' onclick=""> Продолжить </button>
        <button type="button" class="btn btn-secondary rounded-2" data-dismiss="modal"> Закрыть </button>
      </div>
      </div>
    </div>
  </div>
