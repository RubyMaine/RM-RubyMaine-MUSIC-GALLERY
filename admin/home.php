...
<h1 class="text-light">Music Gallery Site - <?php echo $_settings->userdata('firstname')." ".$_settings->userdata('lastname') ?>!</h1>
<hr>
<div class="row">
  <div class="col-12 col-sm-6 col-md-6">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text"> Активные категории </span>
  ...
  <div class="col-12 col-sm-6 col-md-6">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text"> Активные музыки </span>
        <span class="info-box-number text-right h5">
          <?php 
