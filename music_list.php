...
<div class="row">
    <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12 mx-auto mb-5">
        <div class="input-group mb-3">
            <input type="search" id="search_cat" placeholder="Искать здесь"  class="form-control">
...
<div id="player-field">
    ...
    <div id="player-slider">
        <div id="music-title" class="text-light"><span id="title">Music Title</span> - <span class="mx-4 text-muted" id="artist"> Тест </span></div>
