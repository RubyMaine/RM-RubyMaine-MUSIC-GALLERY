...
<div class="row">
    <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12 mx-auto mt-5 mb-3 ">
        <h1 class="text-center font-weight-bolder title-font"> Категории музыки </h1>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-3 cat-items">
                <div class="card rounded-0 card-outline card-primary  h-100">
                    ...
                    <div class="card-footer text-right">
                        <a href="<?= base_url."?page=music_list&cid={$row['id']}" ?>" class="btn btn-sm btn-flat btn-primary bg-gradient-primary"> Посмотреть категорию </a>
                    </div>
                </div>
            </div>
            <?php endwhile; ?>
